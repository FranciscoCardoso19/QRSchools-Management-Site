...
try {
    ...
    $sql = 'INSERT INTO equipamento_categorias (nome) VALUES (:nome)';
    ...
    if ($stmt->rowCount() === 0) {
        throw new Exception('Erro ao inserir o equipamentoCategoria na base de dados');
    }
    ...
    $result = [
        'success' => true,
        'message' => 'equipamentoCategoria criado com sucesso',
    ];
